package com.jbdl63.session8JDBC.Repository;
...
public class StudentRepository
{
    ...
    public int createNewStudentValue(Student student) {
        String updateQuery="UPDATE  Student SET department=student.getDepartment() WHERE studId=student.getStudId()";
