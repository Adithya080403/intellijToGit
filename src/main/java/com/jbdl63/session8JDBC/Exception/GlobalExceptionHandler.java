package com.jbdl63.session8JDBC.Exception;
...
public class GlobalExceptionHandler
{
    ...
    public ResponseEntity<Map<String,String>> errorHandling(MethodArgumentNotValidException e, HttpServletRequest httpServletRequest)
    {
        ...
        e.getBindingResult().getAllErrors().forEach(error->{
            ...
            log.error(String.format("Validation error occured for URL : %S : 400: %S ,%S",httpServletRequest.getRequestURI(),httpServletRequest.getMethod(),message));
